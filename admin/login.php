...
<body>
        ...
        <div class="row d-flex">
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    <div class="row"> <img src="../images/lg-login.png" class="logo"> </div>
                    <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> <img src="../images/DHTL.jpg" class="image"> </div>
                </div>
            </div>
            <div class="col-lg-5">
  ...
  <?php
     if(isset($_POST['sbmLogin'])){
        ...
        if($count == 1){
            $_SESSION['login'] = $email;         //tạo phiên
